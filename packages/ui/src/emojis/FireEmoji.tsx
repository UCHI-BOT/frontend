...
const FireEmoji = React.forwardRef<SVGSVGElement, EmojiProps>(
  ({ size = 20, ...props }, ref) => {
    return (
      <svg
        width={size}
        ...
        {...props}
      >
        <rect width="72" height="72" fill="url(#FireEmojiPattern)" />
        <defs>
          <pattern
            id="FireEmojiPattern"
